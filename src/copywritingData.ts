...
export const PLANS_DATA = {
  ...
  premium: {
    ...
    benefits: [
      "+1000 Sesiones de Entrenamiento de Fútbol Sala",
      "Bono 1: 250 Actividades Sociomotrices de Fútbol Sala (Valorizado en MX$ 490)",
      "Bono 2: 100 Ejercicios de Velocidad y Resistencia para Fútbol Sala (MX$ 650)",
      "Bono 3: 51 Ejercicios de Entrenamiento de Fintas en Fútbol Sala (MX$ 350)",
      "Bono 4: Manual de Entrenamiento de Fútbol Sala (MX$ 850)",
      "Bono 5: Nociones Prácticas sobre Preparación Física, Táctica y Técnica (MX$ 550)",
